...
export default function ProfilePage() {
  ...
  const hw        = [
    p.height ? `${p.height} سم` : null,
    p.weight ? `${p.weight} كغ` : null,
    ...
    <div dir="rtl" style={{ padding: '0 var(--sp-4) var(--sp-8)', maxWidth: 600, margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative' }}>
          <img
            ...
            style={{
              ...
              filter: p.is_photos_blurred ? 'blur(12px)' : 'none',
            }}
          />
          {status.color === '#22c55e' && (
            <div style={{
        ...
        <div style={{
          ...
          {p.city && (
            <span style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-1)', color: 'var(--text-tertiary)', fontSize: 'var(--text-xs)' }}>
      ...
      {pct > 0 && (
        <div style={{
          ...
          border: `1px solid ${pct >= 80 ? 'rgba(34,197,94,0.3)' : 'var(--glass-border)'}`,
        }}>
      ...
      <Block title="البيانات الأساسية" icon={<Users size={13}/>}>
        ...
        <Row icon={<HandHeart size={13}/>}  label="جاهزية الزواج"  value={p.readiness_level === READINESS_LEVEL_NOW ? '🟢 جاهز حالاً' : null} />
      </Block>
      ...
      <Block title="الدين والالتزام" icon={<Moon size={13}/>}>
        ...
        {!isMale && committed && (
          <Row icon={<ShieldCheck size={13}/>} label="اللباس" value={p.hijab_style} />
        )}
      </Block>
      ...
      <Block title="الأطفال" icon={<Baby size={13}/>}>
        ...
        {p.children_count > 0 && (
          <Row icon={<Users size={13}/>} label="الحضانة" value={p.children_custody} />
        )}
      ...
      {!!p.bio && (
        <div style={{
          marginBottom: 'var(--sp-3)', borderRadius: 'var(--radius-md)',
          background: 'var(--glass-bg)', border: '1px solid var(--glass-border)', padding: 'var(--sp-4)',
        }}>
          <p style={{ color: 'var(--text-tertiary)', fontSize: 'var(--text-2xs)', fontWeight: 900, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 'var(--sp-2)' }}>
            نبذة شخصية
          </p>
          <p style={{ color: 'var(--text-secondary)', fontSize: 'var(--text-sm)', lineHeight: 'var(--lh-relaxed)', margin: 0 }}>
            {p.bio}
          </p>
        </div>
      )}
